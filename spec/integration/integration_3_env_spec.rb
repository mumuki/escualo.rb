...
describe 'escualo env', dockerized: true do
  it 'can list env' do
    result, status = scripted_escualo 'env list', 'bootstrapped.yml'
  ...
  it 'can set env' do
    result, status = scripted_escualo 'env list', 'with.foo.env.yml'
  ...
  it 'can unset env' do
    result, status = scripted_escualo 'env unset RACK_ENV ESCUALO_BASE_VERSION', 'bootstrapped.yml'
